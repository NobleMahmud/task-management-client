...
const SignUp2 = () => {
    ...
    return (
        <div>
            <div className="h-full -mt-28 bg-gradient-to-tl from-green-400 to-indigo-900 w-full py-16 px-4">
{/* <!--- more free and premium Tailwind CSS components at https://tailwinduikit.com/ ---> */}
            ...
            <div className="flex flex-col items-center justify-center">
                ...
                <div className="bg-white shadow rounded lg:w-1/2 md:w-1/2 w-full p-10 mt-16">
                    ...
                    <p tabIndex="0" className="focus:outline-none text-sm mt-4 font-medium leading-none text-gray-500">Already have an account? <Link to="/login" href="javascript:void(0)"   className="hover:text-gray-500 focus:text-gray-500 focus:outline-none focus:underline hover:underline text-sm font-medium leading-none  text-gray-800 cursor-pointer"> Log In</Link></p>
                    {/* <button aria-label="Continue with google" role="button" className="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center lg:w-1/2 w-full md:w-full mt-10">
                        ...
                        <p className="text-base font-medium ml-4 text-gray-700 text-center">Continue with Google</p>
                    </button> */}
                    ...
                    <div className="w-full flex items-center justify-between py-5">
                       ...
                       <div>
                            ...
                            <input  type="text" {...register("name", { required: true })} aria-labelledby="email" className="bg-gray-200 border rounded  text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2"/>
                       ...
                       <div>
                            ...
                            <input {...register("email", { required: true})} name="email" type="email" placeholder="email" aria-labelledby="email" className="bg-gray-200 border rounded  text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2"/>
                            {errors.email && <span className="text-red-600">Email is required</span>}
                        </div>
                        {/* photo */}
                        <div className='my-4'>
                        <label  htmlFor="">Select Photo</label> <br />
                        <input  {...register('image', { required: true})} type="file"className="file-input file-input-bordered file-input-sm w-full mt-2 max-w-xs" />
                           ...
                           <div className="relative flex items-center justify-center">
                            <input  {...register("password", { 
                                ...
                                pattern: /(?=.*[A-Z])(?=.*[!@#$&*])(?=.*[0-9])(?=.*[a-z]).{6}/ 
                                 })} name="password" type="password" placeholder="password" id="pass" className="bg-gray-200 border rounded  text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2"/>
                                 {errors.password?.type === "required" && <p className="text-red-600">Password is required</p>}
                            {errors.password?.type === "minLength" && <p className="text-red-600">Password must be atleast 6 characters long</p>}
                        ...
                        {/* log in */}
                        <div className="mt-8">
                            <button role="button" className="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-indigo-700 border rounded hover:bg-indigo-600 py-4 w-full">Sign Up</button>
                        </div>
                       </form>
                </div>
            </div>
